...
import 'package:fyp/widgets/products/image-carousel.dart';
      ...
      Padding(
        ...
        child: Row(
          ...
          children: [
            InkWell(
              onTap: () {
                Navigator.of(context).push(MaterialPageRoute(builder:(ctx) =>  SalesDashboard(shopId: shopId,)));
              },
              child: Container(
                ...
                child: Column(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    Icon(Icons.stacked_bar_chart_sharp, color: Colors.deepOrange, size: 35),
            ...
            InkWell(
              onTap: () {
                Navigator.of(context).push(MaterialPageRoute(builder: (ctx) => GenerateReportsScreen(shopId: shopId,)));
              },
              child: Container(
                width: MediaQuery.of(context).size.width * 0.4,
                height: 200,
                ...
                child: Column(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    Icon(Icons.content_paste_search_sharp, color: Colors.deepOrange, size: 35),
                    const SizedBox(height: 10),
